...
<head>
    ...
    <title>Attendees {{$date}}- CE Isheri</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Attedance for {{$date}}</h4>
                                    ...
                                    @if(count($records) > 0)
                                        @foreach($records as $record)
                                            <tr>
                                                ...
                                                <td>{{$record->user->group}}</td>
                                                <td>{{date("h:i:a",($record->time + 3600))}}</td>
                                                <td>{{$record->user->activity_department }}</td>
