                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    @if(count($members) > 0)
                                        @foreach($members as $member)
                                            <tr>
                                                <td>{{$member->id}}</td>
                                                <td><a href="{{route("showUserProfile",['id'=>$member->id,'name'=>preg_replace('/\s+/', '-', $member->full_name())])}}">{{$member->full_name()}}</a></td>
                                                <td>{{$member->group}}</td>
                                                <td>{{$member->email}}</td>
                                                <td>{{$member->activity_department }}</td>
